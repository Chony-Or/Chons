...
<body class="fixed-bg">
    ...
    <div class="container" style="margin-top:30px">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <img src="img/CNC(bg).png" class="centerimage">
            </div>
    
            <div class="col-md-6">
            <div class="semi-card">
                        <div class="textcolor">
                            <h2 style="margin-left: 7px; margin-top:5px">Black Forest Milkshake</h2><hr style="border-top: 1px solid;">
                            <p style="font-size:15px; margin-left: 10px">Be in the clouds with the taste of this milkshake blended with cherries and topped with crushed cookies.</p><br>
                            
                              <form action="milkshBlackForest.php" method="POST">
						...
						<script>
                            ...
                            <a class="nav-link" href="milkshBlackForest.php" ><img src="https://img.icons8.com/material-rounded/22/000000/shopping-cart.png"/>ADD TO CART</a></button><br><br>
