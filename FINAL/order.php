...
<body>
    ...
    <center> <table class="table table-hover" border=1>
        ...
        <tr style="font-weight:900; font-size:larger; color: white; background-color:#8a5f56">
                <th>Product</th>
                <th>Price</th>
                <th>Quantity</th>
                <th>Total</th>
        ...
        <tr style="font-weight:900; font-size:larger; ">
                ...
                <th style="text-align: center"><br><br>
                        ...
                        <input style="text-align:center; width: 30% ; height: 26px;" id=Input type=number min=1 max=100 value=1>
	...
	document.getElementById('Input').stepDown();
           ...
           <h1 style="font-family: 'Courier'; text-align:right; font-size:20px; margin-right:20px; margin-top:20px;">TOTAL 
           <b style="color:#3CB371; font-size:20px;" >₱90.00</b>
              </h1>

              <button type="button" style=" font-family: 'Consolas'; margin-left:87%;font-size:20px; margin-right:20px; width:150px; height:40px; border-radius:5px; background-color:#8a5f56; color:white">
              <b>CHECKOUT</b></button>
